-- ════════════════════════════════════════════════════════════════════════
-- 014 — Signup provisioning now seeds lifecycle + emits admin signals
--
-- Replaces handle_new_tenant() (005) to additionally: set trial status/plan +
-- 14-day window, log a 'signup' activity event, and raise a 'new_signup' admin
-- notification. Name/slug/locale logic and idempotency are unchanged. The
